        ...
        <div className="memory-page">
            <div className='single-memory-content-container'>
                <div className='single-memory-subcontainer'>
                    ...
                    <img src={`${process.env.REACT_APP_API_URL}/${data.file}`} alt='' className='single-memory-img'></img>
                            ...
                            return (
                                <div className='comment-container'>
                                    <span className='comment-subcontainer'>
                                        <img src={`${process.env.REACT_APP_API_URL}/${data.file}`} alt='' className='comment-img' />
